...
let mut ATC1 = AtomicTransactionComposer { status: Building, method_map: HashMap, txs: vec![ TransactionWithSigner {tx: t3, signer : BasicAccount(acct1)}], signed_txs: vec![sign_txn] };
