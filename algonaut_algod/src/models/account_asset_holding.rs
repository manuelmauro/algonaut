...
pub struct AccountAssetHolding {
    ...
    pub asset_holding: Box<crate::models::AssetHolding>,
    #[serde(rename = "asset-params", skip_serializing_if = "Option::is_none")]
    pub asset_params: Option<Box<crate::models::AssetParams>>,
}
...
impl AccountAssetHolding {
    ...
    pub fn new(asset_holding: crate::models::AssetHolding) -> AccountAssetHolding {
        AccountAssetHolding {
