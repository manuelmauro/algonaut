...
pub struct ApplicationLocalState {
    ...
    pub key_value: Option<Vec<crate::indexer::TealKeyValue>>,
    /// Round when the account opted into the application.
    #[serde(rename = "opted-in-at-round", skip_serializing_if = "Option::is_none")]
    pub opted_in_at_round: Option<u64>,
    #[serde(rename = "schema")]
    pub schema: Box<crate::indexer::ApplicationStateSchema>,
}

impl ApplicationLocalState {
    /// Stores local state associated with an application.
    pub fn new(id: u64, schema: crate::indexer::ApplicationStateSchema) -> ApplicationLocalState {
