...
pub struct ApplicationParams {
    ...
    pub global_state: Option<Vec<crate::indexer::TealKeyValue>>,
    #[serde(
        rename = "global-state-schema",
        skip_serializing_if = "Option::is_none"
    )]
    pub global_state_schema: Option<Box<crate::indexer::ApplicationStateSchema>>,
    #[serde(rename = "local-state-schema", skip_serializing_if = "Option::is_none")]
    pub local_state_schema: Option<Box<crate::indexer::ApplicationStateSchema>>,
}
