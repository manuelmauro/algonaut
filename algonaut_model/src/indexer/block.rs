...
pub struct Block {
    ...
    pub participation_updates: Option<Box<crate::indexer::ParticipationUpdates>>,
    ...
    pub rewards: Option<Box<crate::indexer::BlockRewards>>,
    ...
    pub state_proof_tracking: Option<Vec<crate::indexer::StateProofTracking>>,
    /// \\[ts\\] Block creation timestamp in seconds since eposh
    #[serde(rename = "timestamp")]
    pub timestamp: u64,
    /// \\[txns\\] list of transactions corresponding to a given round.
    #[serde(rename = "transactions", skip_serializing_if = "Option::is_none")]
    pub transactions: Option<Vec<crate::indexer::Transaction>>,
    ...
    pub upgrade_state: Option<Box<crate::indexer::BlockUpgradeState>>,
    #[serde(rename = "upgrade-vote", skip_serializing_if = "Option::is_none")]
    pub upgrade_vote: Option<Box<crate::indexer::BlockUpgradeVote>>,
}
