...
pub struct SimulationTransactionExecTrace {
    ...
    pub approval_program_trace: Option<Vec<crate::algod::SimulationOpcodeTraceUnit>>,
    ...
    pub clear_state_program_trace: Option<Vec<crate::algod::SimulationOpcodeTraceUnit>>,
    ...
    pub logic_sig_trace: Option<Vec<crate::algod::SimulationOpcodeTraceUnit>>,
