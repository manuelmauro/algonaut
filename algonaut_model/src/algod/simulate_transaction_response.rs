...
pub struct SimulateTransactionResponse {
    ...
    pub txn_groups: Vec<crate::algod::SimulateTransactionGroupResult>,
    ...
    pub eval_overrides: Option<Box<crate::algod::SimulateEvalOverrides>>,
    ...
    pub exec_trace_config: Option<Box<crate::algod::SimulateTraceConfig>>,
...
impl SimulateTransactionResponse {
    pub fn new(
        last_round: u64,
        txn_groups: Vec<crate::algod::SimulateTransactionGroupResult>,
        version: u64,
        would_succeed: bool,
