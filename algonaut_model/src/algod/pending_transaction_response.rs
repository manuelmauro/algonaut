...
pub struct PendingTransactionResponse {
    ...
    pub global_state_delta: Option<Vec<crate::algod::EvalDeltaKeyValue>>,
    /// Inner transactions produced by application execution.
    #[serde(rename = "inner-txns", skip_serializing_if = "Option::is_none")]
    pub inner_txns: Option<Vec<crate::algod::PendingTransactionResponse>>,
    ...
    pub local_state_delta: Option<Vec<crate::algod::AccountStateDelta>>,
    ...
    #[serde(rename = "txn")]
    pub txn: crate::algod::ext::transaction::TransactionHeader,
}
...
impl PendingTransactionResponse {
    ...
    pub fn new(
        pool_error: String,
        txn: crate::algod::ext::transaction::TransactionHeader,
