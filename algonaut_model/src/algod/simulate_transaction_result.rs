...
pub struct SimulateTransactionResult {
    ...
    pub exec_trace: Option<Box<crate::algod::SimulationTransactionExecTrace>>,
    ...
    pub txn_result: Box<crate::algod::PendingTransactionResponse>,
}

impl SimulateTransactionResult {
    /// Simulation result for an individual transaction
    pub fn new(txn_result: crate::algod::PendingTransactionResponse) -> SimulateTransactionResult {
