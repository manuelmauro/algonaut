...
pub struct ApplicationLocalState {
    ...
    pub key_value: Option<Vec<crate::algod::TealKeyValue>>,
    #[serde(rename = "schema")]
    pub schema: Box<crate::algod::ApplicationStateSchema>,
}

impl ApplicationLocalState {
    /// Stores local state associated with an application.
    pub fn new(id: u64, schema: crate::algod::ApplicationStateSchema) -> ApplicationLocalState {
